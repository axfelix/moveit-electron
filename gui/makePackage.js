...
function package() {
  ...
  if (packageFolder){
    ...
    client.invoke("bag_package", contactname, department, email, phone, creator, rrsda, title, datefrom, dateto, description, metadata, JSON.stringify(packageFolder[0]), function(error, res, more) {
      if (res === true){
